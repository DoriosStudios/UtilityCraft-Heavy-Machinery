...
export interface BasicMachineOptions {
  ...
  ignoreTick?: boolean;
  /** Overrides how a specialized runtime resolves its helper entity. */
...
export class Generator extends BasicMachine {
  ...
  constructor(block: Block, settings: GeneratorSettings, entityResolver?: (block: Block) => Entity | undefined);
  /**
...
export interface MultiblockDeactivationManager {
  ...
  /** Resolves and deactivates the active structure that owns a general block. */
  deactivateMultiblock(block: Block, player?: Player, emptyBlocksConfig?: FillBlocksConfig): Entity | undefined;
  /** Deactivates an already resolved controller entity. */
  deactivateEntity(entity: Entity, player?: Player, emptyBlocksConfig?: FillBlocksConfig): Entity | undefined;
...
export interface MultiblockEntityManager {
  ...
  getControllerEntityFromBlock(block: Block, permutation?: BlockPermutation): Entity | undefined;
  /** Resolves the active structure whose serialized bounds contain a general block. */
...
export interface MultiblockConstants {
  ...
  readonly MULTIBLOCK_CONTROLLER_TAG: "dorios:multiblock.controller";
