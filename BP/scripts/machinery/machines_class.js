...
import { ProgressManager, Machinery, obtainEnergyFromText, obtainLiquidFromText } from './managers.js'
...
export class Machine extends Machinery {
    ...
    static spawnMachineEntity(e, settings, callback) {
        ...
        system.run(() => {
            ...
            entity.setProperty('dorios:energy', energy);
            entity.setProperty('dorios:energycap', settings.energyCap);
            ...
            if (callback) callback(entity, itemInfo)
        });
    }
